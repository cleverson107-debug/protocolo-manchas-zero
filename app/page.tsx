...
export default function Home(){
  ...
  return <main>
    ...
    <section id="precos" className="section pricing"><div className="container"><Heading eyebrow="OFERTAS" title="Escolha sua oferta"/><div className="price-grid">
      <article id="oferta-simples" className="price-card basic"><h3>Oferta Simples</h3><small>VOCÊ RECEBE:</small><ul><li>Protocolo Manchas Zero</li><li>Acesso Vitalício</li></ul><div className="from">De <s>R$ 37,90</s><br/>Hoje por apenas</div><div className="price-value pix-price"><span>R$</span><strong>17,90</strong></div><div className="from installment">ou 4x de R$ 4,48</div><button onClick={()=>setUpsell(true)}>QUERO O PROTOCOLO</button><Trust compact/></article>
      <article className="price-card complete"><div className="popular">MAIS VENDIDO</div><h3>Oferta Completa</h3><small>VOCÊ RECEBE:</small><ul className="offer-main"><li>Protocolo Manchas Zero</li><li>Acesso Vitalício</li></ul><div className="included-bonuses"><small>BÔNUS INCLUSOS</small><ul><li>Método Asiático Pele Saudável</li><li>Rotina Anti-Oleosidade Noturna</li><li>Grupo Exclusivo no WhatsApp</li></ul></div><div className="from">De <s>R$ 67,90</s><br/>Hoje por apenas</div><div className="price-value pix-price"><span>R$</span><strong>27,90</strong></div><div className="from installment">ou 6x de R$ 4,65</div><a id="comprar" href="#" className="buy-button">QUERO A OFERTA COMPLETA</a><Trust compact/></article>
    </div></div></section>
