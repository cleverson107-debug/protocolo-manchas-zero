...
function Trust({compact=false}:{compact?:boolean}){return <div className={`trust ${compact?'compact':''}`} aria-label="Selos de confiança"><span><i className="trust-mark shield-mark" aria-hidden="true">✓</i><b>Compra<br/>Segura</b></span><span><i className="trust-mark trophy-mark" aria-hidden="true">★</i><b>Satisfação<br/>Garantida</b></span><span><i className="trust-mark lock-mark" aria-hidden="true">●</i><b>Privacidade<br/>Protegida</b></span></div>}
