...
export default function Home(){
  return <main>
    ...
    <section className="hero"><div className="container hero-grid">
      <HeroArt/>
      <div className="hero-copy"><p className="eyebrow">PROTOCOLO MANCHAS ZERO</p><h1>Chega de testar produtos sem saber <span className="soft-highlight">o que realmente sua pele precisa.</span></h1><p className="lead">Com o <span className="soft-highlight">Protocolo Mancha Zero</span>, você aprende a identificar o que pode estar por trás de <span className="soft-highlight">manchas, acne e excesso de oleosidade</span>, melhora sua rotina de cuidados e conquista uma pele com aparência mais uniforme, limpa e saudável <span className="soft-highlight">em até 21 dias</span>.</p><a href="#precos" className="cta hero-cta">QUERO O PROTOCOLO <span>↗</span></a><Trust/></div>
    </div></section>
...
function Trust({compact=false}:{compact?:boolean}){const size=compact?14:19;return <div className={`trust ${compact?'compact':''}`} aria-label="Selos de confiança"><span><TrustIcon type="shield" size={size}/><b>Compra<br/>Segura</b></span><span><TrustIcon type="trophy" size={size}/><b>Satisfação<br/>Garantida</b></span><span><TrustIcon type="lock" size={size}/><b>Privacidade<br/>Protegida</b></span></div>}
function TrustIcon({type,size}:{type:'shield'|'trophy'|'lock';size:number}){return <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">{type==='shield'?<><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10Z"/><path d="m9 12 2 2 4-4"/></>:type==='trophy'?<><path d="M8 21h8M12 17v4M7 4h10v5a5 5 0 0 1-10 0V4Z"/><path d="M7 6H4v2a4 4 0 0 0 4 4M17 6h3v2a4 4 0 0 1-4 4"/></>:<><rect x="4" y="10" width="16" height="11" rx="2"/><path d="M8 10V7a4 4 0 0 1 8 0v3M12 14v3"/></>}</svg>}
