...
export default function Home(){
  ...
  return <main>
    ...
    <section id="precos" className="section pricing"><div className="container"><Heading eyebrow="OFERTAS" title="Escolha sua oferta"/><div className="price-grid">
      <article className="price-card basic"><small>VOCÊ RECEBE:</small><h3>Oferta Simples</h3><ul><li>Protocolo Manchas Zero</li><li>Acesso Vitalício</li></ul><div className="from">De <s>R$ 37,90</s><br/>Hoje por apenas</div><div className="price-value"><span>4x de R$</span><strong>4,48</strong></div><div className="from">ou R$ 17,90 à vista no Pix</div><button onClick={()=>setUpsell(true)}>QUERO O PROTOCOLO</button><Trust compact/></article>
